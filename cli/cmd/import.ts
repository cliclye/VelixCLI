...
import type { Session as SDKSession, Message, Part } from "@velix-ai/sdk/v2"
...
/** Extract share ID from a share URL like https://velix.ai/share/abc123 */
...
export function transformShareData(shareData: ShareData[]): {
  ...
  const sessionItem = shareData.find((d): d is Extract<ShareData, { type: "session" }> => d.type === "session")
