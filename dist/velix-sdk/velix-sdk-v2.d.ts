...
export type ToolState = (ToolStateBase & {
...
export type Part = FilePart | TextPart | AgentPart | ToolPart | StepStartPart | StepFinishPart | ReasoningPart;
...
export interface VelixClient {
    ...
    config: {
        ...
        providers(): Promise<ClientResult<{
            providers: Provider[];
            default: Record<string, string>;
        }>>;
    };
    event: {
        subscribe(input?: Record<string, unknown>, options?: {
            signal?: AbortSignal;
    ...
    app: {
        agents(input?: Record<string, unknown>, options?: {
...
export declare function createVelixClient(_options?: VelixClientOptions): VelixClient;
export {};
//# sourceMappingURL=velix-sdk-v2.d.ts.map